...
export default function Footer() {
  ...
  return (
    <footer className="mt-20 border-t border-blush/60 bg-cream">
      <div className="mx-auto max-w-6xl px-5 md:px-8 py-10 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-charcoal/60">
